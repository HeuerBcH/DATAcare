    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('gestor', 'Gestor/Coordenador de UBS'), ('acs', 'Agente Comunitário de Saúde'), ('profissional_saude', 'Profissional de Saúde'), ('admin', 'Administrador')], default='profissional_saude', max_length=20, verbose_name='Papel')),
